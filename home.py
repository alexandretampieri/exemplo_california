...
with coluna1:
    ...
    with st.form(key="formulario"):
        ...
        selecionar_condado = st.selectbox("Condado (Califórnia)", condados)
        ...
        housing_median_age = st.number_input(
            "Idade do imóvel (entre 1 e 50 anos)", value=10, min_value=1, max_value=50
        )
...
with coluna2:
    ...
    polygon_layer = pdk.Layer(
        "PolygonLayer",
        data=gdf_geo[["name", "abbrev", "geometry"]],
    ...
    highlight_layer = pdk.Layer(
        "PolygonLayer",
        data=condado_selecionado[["name", "abbrev", "geometry"]],
        get_polygon="geometry",

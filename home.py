...
selecionar_condado = st.selectbox("Condado do Estado da Califórnia", condados)
...
housing_median_age = st.number_input("Idade do imóvel (entre 1 e 50 anos)", value=10, min_value=1, max_value=50)
...
median_income = st.slider("Renda média (milhares de US$)", 5.0, 100.0, 50.0, 5.0)
